...
if (document.getElementsByClassName('demo').length > 0) {
  ...
  var txt = `details
            ...
            Email: liangzhang815@gmail.com

            Language: | English | Mandarin | Cantonese | Japanese
            
            Programming: | Java | Javascript | Python | C++ | C# | C

            Web & Database: | HTML | CSS | NodeJS | SQL | Spring Boot | ReactJS

            Tech: | Git & GitHub | Unix | VSCode | MSExcel | Salesforce
